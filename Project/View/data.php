<form class="box1" onsubmit="return false" method="GET">
    ...
    <br><label for="type">Insert/Delete:</label>
    ...
    <br><select id="category" name="category">
        ...
        <option value="FEMALE ACTOR IN A TELEVISION MOVIE OR LIMITED SERIES">FEMALE ACTOR IN A TV MOVIE</option>
        <option value="MALE ACTOR IN A TELEVISION MOVIE OR LIMITED SERIES">MALE ACTOR IN A TV MOVIE</option>
    ...
    <br><label for="actorname">Actor Name:</label>
